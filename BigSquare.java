...
public class BigSquare{
	...
	private SmallSquare[] _STTT; //checks
	...
	public int normalTurn(int index, char ai_mode){
		...
		_STTT[index].populate(); //populate adds numbers to selected square
		printBoard();
		_STTT[index].unpopulate(); //unpopulate removes the numbers
		int ans = pickSquare(_STTT[index], ai_mode); //returns the square the AI picked
		return ans;
	}
